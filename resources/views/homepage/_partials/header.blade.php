<header>
		<div class="container nav-menu">
			<div class="row">
				<div class="col-md-12">
					<a href="index-2.html"><img src="{{ asset('splash_assets/images/responsive-logo.png') }}" class="responsive-logo img-fluid" alt="responsive-logo"></a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
						...
						<div class="collapse navbar-collapse" id="navbarNavDropdown">
							<ul class="navbar-nav">
								...
								<li class="nav-logo">
									<a href="#" class="navbar-brand"><img src="{{ asset('splash_assets/images/logo.png') }}" class="img-fluid" alt="logo"></a>
								</li>
								<li class="nav-item">
			...
			<div id="carousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<img class="d-block" src="{{ asset('splash_assets/images/slider.jpg') }}" alt="First slide">
					...
					<div class="carousel-item">
						<img class="d-block" src="{{ asset('splash_assets/images/slider-2.jpg') }}" alt="Second slide">
						<div class="carousel-caption d-md-block">
							<div class="slider_title">
					...
					<div class="carousel-item">
						<img class="d-block" src="{{ asset('splash_assets/images/slider-3.jpg') }}" alt="Third slide">
						<div class="carousel-caption d-md-block">
							<div class="slider_title">
