			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="foot-logo">
							<a href="index-2.html">
								<img src="{{ asset('splash_assets/images/footer-logo.png') }}" class="img-fluid" alt="footer_logo">
							</a>
							<p>2016 © copyright
						...
						<div class="col-md-3">
							<div class="address">
								...
								<p>Email : <a href="https://demo.web3canvas.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b5dcdbd3daf5c0dbdcc6d6da9bd6dad8">[email&#160;protected]</a>
